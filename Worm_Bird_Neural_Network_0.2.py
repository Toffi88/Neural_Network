...
class organism_worm():
    ...
    def position_update_worm(self, food_list, bird_list):
        ...
        # enemy_pos_x = dis_width/2 - enemy_pos_x * -1
        # enemy_pos_x = dis_height/1.5 - enemy_pos_x * -1

        X = [target_pos_x, target_pos_y, enemy_pos_x, enemy_pos_y]
